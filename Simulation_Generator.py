...
def generate_manhattan_grid(net_file = "net.net.xml",x=3,y=3,lanes=2,length=100): ####
...
def generate_cars(route_file,Net_file='net.net.xml',trips_file = "trips.trips.xml",end_time=1000):
    ...
    # print("randomTrips.py -n "+ str(Net_file) +" -e "+ str(end_time)+" -o "+str(trips_file)+ " --period 2.0")
    os.system("randomTrips.py -n "+ str(Net_file) +" -e "+ str(end_time)+" -o "+str(trips_file)+ " --period 2.0 ")
